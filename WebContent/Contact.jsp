...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>Welcome to Ramtek Darshan</title>
        <!-- Meta -->
        ...
        <div id="body-bg">
            <ul class="social-icons pull-right hidden-xs">
                ...
                <li class="social-facebook">
                    <a href="https://www.facebook.com/ramtekdarshan/" target="_blank" title="Facebook"></a>
                </li>
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-9">
                            ...
                            <p>You may Contact us.Please fill the form below and we will contact you soon.</p>
                            <br>
                            <!-- Contact Form -->
                            <form>
                                <label>Name</label>
                ...
                <div class="container padding-vert-30 margin-top-60">
                    <div class="row">
                        ...
                        <div class="col-md-3 margin-bottom-20 padding-vert-30 text-center">
                            <h3 class="color-gray margin-bottom-10">Stay Connected</h3>
                            <p>
